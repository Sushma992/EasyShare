    ...
    protected Boolean doInBackground(String... args) {
        ...
        try {
           ...
           // !!! Please provide application id and password and remove this line. !!!
                    ...
                    restClient.applicationId = "ImageTextCloudAbbyy";
            // You should get e-mail from ABBYY Cloud OCR SDK service with the application password
            restClient.password = "HtpqSYQGkqfYAb4OWRxazp7Y";
            ...
            if( !settings.contains(instIdName)) {
                ...
                publishProgress( "Scanning Image...");
            ...
            publishProgress( "Scanning Image... takes few Seconds");
            ...
            publishProgress("Scanning Image...please wait");
